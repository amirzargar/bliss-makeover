...
export default function Customers() {
    ...
    return (
        <div>
            ...
            {/* ?? Left: list (always full width on mobile, flex on desktop) ?? */}
                            ...
                            {filtered.map(c => {
                                ...
                                return (
                                    <div key={c.id}
                                        ...
                                        className={`bg-white rounded-xl border p-3 flex items-center gap-3 cursor-pointer hover:border-pink-200 transition-colors ${selected?.id === c.id ? 'border-pink-300 bg-pink-50' : 'border-gray-100'
                                            }`}>
...
function ProfileContent({ selected, history, loadingHistory, onClose, onDelete }) {
    ...
    return (
        <>
            ...
            <div className="flex items-start justify-between mb-4">
                ...
                <button onClick={onClose} className="text-gray-300 hover:text-gray-500 text-lg font-bold">
                    x
                </button>
            </div>
            ...
            <div className="space-y-2 text-sm mb-4">
                {selected.email && (
                    <div className="flex justify-between">
                        ...
                        <span className="text-gray-700 truncate ml-2">{selected.email}</span>
                    </div>
                )}
                    ...
                    <div className="space-y-2">
                        {history.map(h => (
                            <div key={h.id} className="flex items-center gap-2 text-xs">
                                ...
                                <span className={`px-1.5 py-0.5 rounded text-xs font-medium ${h.status === 'completed' ? 'bg-green-50 text-green-600' : 'bg-gray-100 text-gray-400'
                                    }`}>
                                    {h.status}
                                </span>
                            </div>
